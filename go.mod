...
require (
	...
	github.com/onflow/flow-emulator v1.0.0-preview.16 // indirect
	...
	github.com/onflow/flow-go v0.34.0-crescendo-preview.9.0.20240403221216-33c1de004dc1 // indirect
